...
export default function PromoModal({ section }) {
  const [isOpen, setIsOpen] = useState(false);
  const storageKey = `digitalizacion_popup_shown_${section}`;

  useEffect(() => {
    // Comprobar si ya se mostró en esta sección durante esta sesión de navegación
