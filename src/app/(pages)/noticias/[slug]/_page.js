import { fetchNews, getNewsById, getNewsBySlug } from "@/app/lib/DataNews";
...
export default async function NewsDetailPage({ params, searchParams }) {
  ...
  const newsDetailId = await getNewsById(id);
        ...
        <div className="row">
          ...
          <section className="col-lg-8">
            <article>
              ...
              <h1 className="mb-4">{newsDetail.title} - {id} - {newsDetailId.data.id}</h1>
              {newsDetail.image && (
                <>
